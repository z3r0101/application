...
class cmsDatabaseClass {
    ...
    function __construct($index = 0) {
        ...
        if ($this->mysqli->connect_error) {
            print pageError("Database connection failed", $this->mysqli->connect_error);
            exit;
        } else {
            ...
            if (count($cmsDBCheckData) == 0) {
                ...
                if (isset($_POST["cms-super-admin-setup"])) {
                    ...
                    $CMS_Users_Name = (isset($_POST["cms-username"])) ? trim($_POST["cms-username"]) : "";
                    ...
                    if ($CMS_Users_Name == '') {
                        $arrDBErrorMsg[] = "Username is required";
                    }
...
//                            <input type="text" name="cms-username" {$cmsUsername} style="width: 40%; padding: 0.4%; margin-bottom: 0.2%" placeholder="E.g. johndoe / john_doe / john-doe / john.doe" required><br>
//                            <div style="width: 40%; padding: 0.4%; margin-bottom: 0.9%">You may change the default username <strong>admin</strong></div>
...
//
//
//                    print pageError("Super Administrator", $htmlData);
//                    exit;
//                }
            }
        }
